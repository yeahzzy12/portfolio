    ...
    <section id="contact" className="py-24 px-6 bg-slate-950/50">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">연락하기</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            {/* GitHub URL을 여기에 입력하세요 */}
            <a
              href="https://github.com/your-username"
              target="_blank"
              rel="noopener noreferrer"
              className="px-8 py-3 border border-slate-600 hover:border-slate-400 text-slate-300 hover:text-white rounded-lg transition-colors inline-flex items-center gap-2 justify-center"
            >
