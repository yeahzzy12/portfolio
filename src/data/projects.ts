...
export type Project = {
  ...
  solution: string;
  image?: ProjectImage;
  images?: ProjectImage[]; // 다중 이미지 (갤러리)
  diagramLabel?: string;
  noVisual?: boolean; // 이미지/구조도 영역 없이 텍스트만 표시
  solo?: boolean;
  pl?: boolean;
};
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    pl: true,
    // public/images/ 폴더에 아래 파일명으로 이미지를 추가해주세요
    images: [
      { src: "/images/project5-pc.png", alt: "KDIS 전자출결 시스템 — PC" },
      { src: "/images/project5-mobile.png", alt: "KDIS 전자출결 시스템 — 모바일" },
      { src: "/images/project5-kiosk.png", alt: "KDIS 전자출결 시스템 — 키오스크" },
    ],
  },
];
